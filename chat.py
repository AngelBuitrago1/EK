...
st.set_page_config(page_title='Automation Anywhere - AAI EK', page_icon = 'https://chat-beta.automationanywhere.com/assets/icon/favicon.ico', layout='wide')
st.header("Incapacidades - Automation Anywhere - AAI EK")
